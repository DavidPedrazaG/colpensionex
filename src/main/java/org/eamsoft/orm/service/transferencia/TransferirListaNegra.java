...
public class TransferirListaNegra {
    ...
    public ResultadoValidacion transferirAListaNegra(Cotizante cotizante){        
        ...
        return new ResultadoValidacion(false, "Rechazado: Tiene observación disciplinaria, sera pasado a la lista negra con fecha de hoy "+sdf.format(cotizante.getEnListaNegraUltimos6Meses()));
    }
